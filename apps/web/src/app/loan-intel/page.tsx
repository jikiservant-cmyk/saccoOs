  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-3xl font-black uppercase tracking-tight mb-4">Loan Intelligence</h1>
        <p className="text-slate-500">Global lending behavior and risk patterns.</p>
        <div className="mt-8 bg-white p-12 rounded-3xl border border-slate-200 text-center italic text-slate-400">
          Advanced loan analytics coming soon...
        </div>
      </div>
    </div>
  );
